...
export class CustomerDetailsService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/customer-details';
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICustomerDetails[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
